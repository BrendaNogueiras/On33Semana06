...
with open('Temperatura.csv', 'w' , encoding="UTF-8") as csvfile: #w é write, ENCODING para tirar os acentos
    escritor = csv.writer(csvfile)
    escritor.writerow(['dia', 'mês', 'temperatura', 'chuva']) #cria cabeçalho
    escritor.writerows(novas_temperaturas) #importa os dados acima na planilha
